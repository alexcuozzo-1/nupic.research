...
from nupic.research.frameworks.greedy_infomax.utils.GIM_model_utils import makeDeltaOrthogonal

class InfoNCE_Loss(nn.Module):
    def __init__(self, in_channels, out_channels, negative_samples=16,
                 prediction_step=5, weight_init=True):
        super().__init__()
        self.negative_samples = negative_samples
        self.k_predictions = prediction_step
